...
def test_random_rotation(dataPath, decodeImgShape, batchSize, isTrain, numImgs=5, margin=5, savePath='../debugImgs'):
    winName = "Show"
    ...
    try:
        for i in range(numTests):
            ...
            cv2.imwrite(os.path.join(savePath, 'test_random_rotation_' + str(i).zfill(2) + '.png'), canvas)
...
if __name__ == '__main__':
    ...
    test_random_rotation(dataPath_, decodeImgShape_, batchSize_, isTrain_, numImgs_)
